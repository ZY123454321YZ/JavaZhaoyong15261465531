...
//        try{
//           imeMsg.setRecipients(Message.RecipientType.CC, (Address[])InternetAddress.parse(copyto));
//            return true;
//        }catch(Exception e){
//            return false;
//        }
...
//            mailSession = Session.getInstance(props, null);
    ...
    public static void main(String[] args){
        ...
        String mailbody = "<meta http-equiv=Content-Type content=text/html;charset=utf-8>" +
                          "<div align=center>邮件正文内容</div>"+
                          "<a href='http://www.baidu.com/'>百度aaaaaaaaaaaaaashabi</a>";

        SendAttachment themail = new SendAttachment("smtp.qq.com");
        themail.setNeedAuth(true);

        if(themail.setSubject("邮件主题") == false) return;
        if(themail.setBody(mailbody) == false) return;
        if(themail.setTo("834162364@qq.com") == false) return;
        //以上是收件人处理
        if(themail.setFrom("834162364@qq.com") == false) return;
